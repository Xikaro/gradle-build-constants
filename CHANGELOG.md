...
- Task property to control whether the pre-defined constants are included in the generated
  class file. Thanks to @Xikaro for the feature request and PR.
...
[unreleased]: https://github.com/cthing/gradle-build-constants/compare/2.2.0...HEAD
[2.2.0]: https://github.com/cthing/gradle-build-constants/releases/tag/2.2.0
